...
import { WaterOverview } from "../../components/water-overview";
...
export default async function WaterPage() {
  try {
    ...
    return <main className="shell"><SiteNav section="water" /><WaterOverview overview={overview} /><Suspense fallback={<section className="workspace-loading" aria-busy="true">Preparo l’atlante idrico…</section>}><WaterWorkspace data={data} /></Suspense></main>;
  } catch (error) {
