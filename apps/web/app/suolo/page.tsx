...
export default async function SoilPage() {
  try {
    ...
    return <main className="shell soil-shell">
      ...
      <Suspense fallback={<section className="workspace-loading" aria-busy="true">Preparo l’esploratore…</section>}><ThemeWorkspace data={data} themeLabel="consumo di suolo" domain="soil" selectionPreferences={{ defaultMetric: "soil_net_consumption_hectares", preferredLevel: "municipality" }} /></Suspense>
    </main>;
  } catch (error) {
